...
/*  * Java Program to use compute() method of Java 8  * to atomically update values in ConcurrentHashMap  */
...
/*	you can also use  computeIfAbsent() or computeIfPresent() method Constructor of LongAdder 
//		will be only called when a value for   given key is not exists
